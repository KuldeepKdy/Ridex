    ...
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <motion.img
          ...
          style={{ filter: "drop-shadow(0px 8px 24px rgba(0, 0, 0, 0.14))" }}
          whileHover={{
            scale: 1.06,
            filter: "drop-shadow(0px 12px 32px rgba(0, 0, 0, 0.22))",
          }}
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex flex-shrink-0 w-10 h-10 rounded-2xl bg-zinc-100 border border-zinc-200">
